...
Command: npx gltfjsx@6.5.3 p1.gltf 
Author: Nic (https://sketchfab.com/heynic)
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/p1/p1.gltf')

  materials.Carpaint.color = new THREE.Color(props.color);
